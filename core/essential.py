...
class Date(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self, display_name='Date', data_type=models.LogEntryFieldDataType.DATE)
...
class TailNumber(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        ...
        data_type=models.LogEntryFieldDataType.SHORT_TEXT)
  ...
  def to_string(self, value):
    ...
    return models.BasicLogEntryFieldType.to_string(self, value)


@engine.register
class AircraftModel(models.BasicLogEntryFieldType):

  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Aircraft Model',
        data_type=models.LogEntryFieldDataType.SHORT_TEXT)

  @engine.require([TailNumber])
  def compute(self, context, tail_number):
    aircraft = models.Aircraft.objects(tail_number=tail_number).first()
    if not aircraft:
      return

    aircraft_model = aircraft.get_aircraft_model()
    if not aircraft_model:
      return

    return aircraft_model.model
...
class TimeOut(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        ...
        data_type=models.LogEntryFieldDataType.DATETIME)
...
class TachOut(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Tach Out',
        data_type=models.LogEntryFieldDataType.FLOAT)
...
class SimulatedInstrumentTime(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Simulated Instrument Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
class ActualInstrumentTime(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Actual Instrument Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
@engine.register
class MultiEngineTime(models.BasicLogEntryFieldType):

  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Multi Engine Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)

  @engine.require([TailNumber, TotalTime])
  def compute(self, context, tail_number, total_time):
    aircraft = models.Aircraft.objects(tail_number=tail_number).first()
    if not aircraft:
      return
    ...
    if not aircraft_model:
      return
    if aircraft_model.number_of_engines <= 1:
      return
...
@engine.register
class HighPerformanceTime(models.BasicLogEntryFieldType):

  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='High Performance Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
  ...
  def compute(self, context, tail_number, total_time):
    ...
    engine_model = aircraft.get_engine_model()
    if not engine_model:
      return
    if engine_model.horsepower <= 200:
      return
...
class CrossCountryTime(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Cross Country Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
class CrossCountryTime15nm(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Cross Country (15nm) Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
class CrossCountryTime25nm(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Cross Country (25nm) Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
class CrossCountryTime50nm(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Cross Country (50nm) Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
class NightTime(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Night Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)

  @engine.require([DepartureAirport, ArrivalAirport, TimeOut, TimeIn])
  def compute(self, context, departure_airport, arrival_airport, time_out,
              time_in):
    ...
    try:
      departure_geolocation = models.Airport.objects.get(
          icao_id=departure_airport).geolocation
      arrival_geolocation = models.Airport.objects.get(
          icao_id=arrival_airport).geolocation
    except:
      return None
    ...
    (dawn, dusk) = utility.get_civil_twilight_time(date_out,
                                                   departure_geolocation)
    if dawn < dusk:
      if time_out < dawn:
    ...
    (dawn, dusk) = utility.get_civil_twilight_time(date_in,
                                                   arrival_geolocation)
    if dawn < dusk:
      if time_in < dawn:
        end_of_day = datetime.combine(date_out + one_day, datetime.time())
...
class CrossCountryNightTime(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Cross Country Night Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
class CrossCountryNightTime15nm(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Cross Country (15nm) Night Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
class CrossCountryNightTime25nm(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Cross Country (25nm) Night Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
class CrossCountryNightTime50nm(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Cross Country (50nm) Night Time',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)
...
class DualReceivedTime(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Dual Received',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)

  @engine.require([TotalTime])
  def compute(self, context, total_time):
    instructor = [
        x for x in context.participants
        if x != context.current_participant and x.role ==
        models.ParticipantRole.INSTRUCTOR
    ]
    if instructor:
      return total_time
    else:
...
class DualGivenTime(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Dual Given',
        data_type=models.LogEntryFieldDataType.TIMEDELTA)

  @engine.require(
      [TotalTime], participant_role=models.ParticipantRole.INSTRUCTOR)
  def compute(self, context, total_time):
    pilot_roles = [
        models.ParticipantRole.STUDENT, models.ParticipantRole.PILOT,
        models.ParticipantRole.INSTRUCTOR
    ]
    other_pilots = [
        x for x in context.participants
        if x != context.current_participant and x.role in pilot_roles
    ]
    if other_pilots:
      return total_time
...
class DayLanding(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        self,
        display_name='Landing (Day)',
        data_type=models.LogEntryFieldDataType.INTEGER)
...
class Approaches(models.ObjectLogEntryFieldType):
  ...
  def __init__(self):
    models.ObjectLogEntryFieldType.__init__(
        self, display_name='Approaches', object_cls=Approach)
...
class Remarks(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        ...
        data_type=models.LogEntryFieldDataType.LONG_TEXT)
...
class FlightReview(models.BasicLogEntryFieldType):
  ...
  def __init__(self):
    models.BasicLogEntryFieldType.__init__(
        ...
        data_type=models.LogEntryFieldDataType.BOOLEAN)
